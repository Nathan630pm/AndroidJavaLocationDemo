...
public class LocationManager {
    ...
    private final String[] permissionArray = new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION};
    ...
    static LocationManager getInstance() {return ourInstance;}
    ...
    private void createLocationRequest() {
        ...
        this.locationRequest.setInterval(5000); // refresh location every 5 seconds
    }

    public void checkPermissions(Context context) {
        this.locationPermissionGranted = (ContextCompat.checkSelfPermission(context.getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED);
    ...
    public MutableLiveData<Location> getLastLocation(Context context) {
        if(this.locationPermissionGranted) {
            ...
            // explain to the user why location is unavailable.
            // also request permissions again lul
        }
